...
public abstract class QueryService<T> {
   ...
   */
  protected <X> Specification<T> buildSpecification(Filter<X> filter,
   ...
   * @return a Specification
   */
  protected Specification<T> buildStringSpecification(StringFilter filter,
   ...
   * @return a Specification
   */
  protected Specification<T> buildSpecification(StringFilter filter,
   ...
   */
  protected <OTHER, X> Specification<T> buildReferringEntitySpecification(Filter<X> filter,
      SetAttribute<T, OTHER> reference, SingularAttribute<OTHER, X> valueField) {
  ...
  protected <OTHER, MISC, X> Specification<T> buildReferringEntitySpecification(
      Filter<X> filter, Function<Root<T>, SetJoin<MISC, OTHER>> functionToEntity,
