...
public class OpenYichAsyncTaskExecutorTest {
  ...
  public void setup() {
    ...
    executor = new TestOpenYichAsyncTaskExecutor(task);
    recorder = LogbackRecorder.forClass(OpenYichAsyncTaskExecutor.class).reset().capture("ALL");
  }
  ...
  public void testExecuteWithException() {
    ...
    assertThat(event.getMessage()).isEqualTo(OpenYichAsyncTaskExecutor.EXCEPTION_MESSAGE);
  ...
  private class TestOpenYichAsyncTaskExecutor extends OpenYichAsyncTaskExecutor {

    TestOpenYichAsyncTaskExecutor(AsyncTaskExecutor executor) {
      super(executor);
    }
